...
-- Write a query to get the first name, last name and the length of the full name of all 
-- the employees from the employees table.

SELECT first_name, last_name, Length (first_name) + length(last_name) AS "Length of the full name" FROM employees;
